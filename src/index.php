...
if (isset($_GET['logout'])) {
	 ...
	 $dbc = mysqli_connect('localhost', 'root', '2a92c9', 'db') or die ('Ошибка соединения с Mysql-сервером');
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-image: url(img/pattern.png), url(img/bg_my.jpg);">
		<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 20%;" class="tbl_login" align="center">
			...
			<tr>
				<td colspan="3" align="center"><a href="javascript://">Забыли пароль?</a> | <a href="page/register.php">Регистрация</a></td>
			</tr>
			<tr>
				<td colspan="3" align="cetner">
					<center><input type="button" onClick="postForm();" value="Войти" class="log_form_btn" /></center>
				</td>
			</tr>
		</table>
